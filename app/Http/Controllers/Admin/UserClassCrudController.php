...
/**
 * Class UserClassCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class UserClassCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\UserClass::class);
    ...
    {
        CRUD::setValidation(UserClassRequest::class);
