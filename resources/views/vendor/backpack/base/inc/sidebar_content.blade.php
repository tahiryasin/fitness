...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('class') }}'><i class='nav-icon la la-question'></i>All Classes</a></li>
...
@if(backpack_user()->hasRole('manager'))
    ...
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('user-class') }}'><i class='nav-icon la la-question'></i> Bookings</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('userss') }}'><i class='nav-icon la la-question'></i> Users</a></li>
